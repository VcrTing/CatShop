...
;(function($){
  ...
  AjaxForm.prototype = {
    ...
    , ainit: function(){
      this.$mask = $('<div class="mask"><h1 style="text-align:center.css;"><i class="fa-spinner fa-spin fa fa-large"></i></h1></div>')
  ...
  QuickAddBtn.prototype = {
    ...
    , click: function(e) {
      ...
      if(!this.modal){
        ...
        var self = this
        modal.find('.modal-body').html('<h2 style="text-align:center.css;"><i class="fa-spinner fa-spin fa fa-large"></i></h2>')
